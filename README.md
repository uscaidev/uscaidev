...
현장의 병목을 AI 에이전트로 다시 설계하고 검증한 뒤, 어느 기관이든 쓸 수 있게 여기에 저장해 둡니다.
...
| 🏺 **[곳간](https://github.com/uscaidev/gotgan)** | 공공 AI 도입과 현장 자동화에 필요한 자료·프롬프트·운영 지식을 모아 두는 의성군 AI 작업 저장고 | 🆕 저장소 생성 |
...
| 📚 **데이터** | 군정 간행물 **7,124쪽** 하이브리드 RAG 구축 · Hadoop·ELK 기반 빅데이터 플랫폼 구축 다수 |
...
![Hadoop](https://img.shields.io/badge/Hadoop-66A5AD?style=for-the-badge&logo=apachehadoop&logoColor=black)
![RAG](https://img.shields.io/badge/RAG-7A4FA0?style=for-the-badge)
![RPA](https://img.shields.io/badge/RPA-2E7D4F?style=for-the-badge)
